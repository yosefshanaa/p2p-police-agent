...
> **Role of this repository: POLICE agent** — `uv run p2p-pursuit peer` defaults to `--role police` here (`ROLE` marker). Sister (thief) repository: https://github.com/yosefshanaa/p2p-thief-agent
